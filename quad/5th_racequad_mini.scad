...
//side_pocket();
top_plate();
//translate([0,0,p2_z+36]) top_plate();
...
module side_pocket() {
    %pole_cut(in=12);
    translate([46/2,0,p2_z]) difference() {
        union() {
            translate([0,25,0]) cylinder(d=6, h=1);
            translate([0,-25,0]) cylinder(d=6, h=1);
            translate([-6,-25,0]) cube([12,50,35]);
            translate([-1,-6,35]) cube([2,12,1.5]);
        }
        translate([-5,-25,1]) cube([10,50,33]);
        translate([0,25,0]) cylinder(d=screw_d, h=10);
        translate([0,-25,0]) cylinder(d=screw_d, h=10);
...
module top_plate() {
    ...
    difference() {
        ...
        pole_cut();
        //Battery straps
        translate([p2_x/2-6,-23/2,-1]) slot(3,23,5);
        translate([-p2_x/2+6,-23/2,-1]) slot(3,23,5);
        translate([p2_x/2-6,44,-1]) slot(3,15,5);
        translate([-p2_x/2+6,44,-1]) slot(3,15,5);
        translate([p2_x/2-6,-44-15,-1]) slot(3,15,5);
        translate([-p2_x/2+6,-44-15,-1]) slot(3,15,5);
        ...
        translate([0,60,-1]) cylinder(d=6.5, h=10);
        translate([10,40,-1]) cylinder(d=6.5, h=10);
        translate([0,-60,-1]) cylinder(d=screw_d, h=10);
        translate([0,-50,-1]) cylinder(d=screw_d, h=10);
...
module p2() {
    difference() {
        union() {
            ...
            //cross
            hull() {
                translate([back_mount_x+5, back_mount_y-5, 0]) rotate([0,0,back_mount_angle])cylinder(d=10, h= p2_z);
            ...
            hull() {
                ...
                translate([front_mount_x+5, front_mount_y+5, 0]) rotate([0,0,front_mount_angle])cylinder(d=10, h= p2_z);
            }
            hull() {    
                translate([-front_mount_x-5, front_mount_y+5, 0]) rotate([0,0,180-front_mount_angle])cylinder(d=10, h= p2_z);
                translate([-back_mount_x-5, back_mount_y+5, 0]) rotate([0,0,180-back_mount_angle])cylinder(d=10, h= p2_z);
            }
            hull() {
...
module p4() {
    difference() {
        union() {
            p2();
            xxx=55;
            translate([-xxx/2,-xxx/2,0]) cube([xxx,xxx,0.5]);
        }
        p2p_holes(_d=6);
        //pole_cut();
        power_board();
...
module pole_cut(in=3) {
    ...
    translate([p2_x/2-4,c1,-1]) cylinder(d=in, h=10, $fn=fn);
    translate([-p2_x/2+4,c1,-1]) cylinder(d=in, h=10, $fn=fn);
    translate([p2_x/2-4,-c1,-1]) cylinder(d=in, h=10, $fn=fn);
    translate([-p2_x/2+4,-c1,-1]) cylinder(d=in, h=10, $fn=fn);
    
    translate([p2_x/2-4,c2,-1]) cylinder(d=in, h=10, $fn=fn);
    translate([-p2_x/2+4,c2,-1]) cylinder(d=in, h=10, $fn=fn);
    translate([p2_x/2-4,-c2,-1]) cylinder(d=in, h=10, $fn=fn);
    translate([-p2_x/2+4,-c2,-1]) cylinder(d=in, h=10, $fn=fn);
    
    %translate([p2_x/2-4,c2,-1]) cylinder(d=8, h=10, $fn=fn);
    %translate([p2_x/2-4,-c2,-1]) cylinder(d=8, h=10, $fn=fn);
    %translate([p2_x/2-4,-c1,-1]) cylinder(d=8, h=10, $fn=fn);
}
...
module d250() {
    difference() {
        cylinder(d=242,h=3);
        translate([0,0, -1])cylinder(d=210,h=5);
    }
}
